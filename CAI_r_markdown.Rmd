...
# take a look at patient 29's biomarkers; use test_date for now since so many missing test_collection_date missing
...
Confirmed! We can see medications prescribed to this patient that further uncertainty we have in the characterization of their condition. Exemestane is typically used to treat hormone-receptor-positive breast cancer in women who have experienced menopause. Further, Zoledronic acid is used to treat bone disease in patient with cancer, and Dexamethasone is a steroid with many uses throughout cancer care.
...
2. The number of non-cancer comorbid diagnoses the patient has
...
With all of this in mind we've begun to get a more detailed idea of this patient's journey. We see a white, 61 year old, post-menopausal female with a primary diagnosis of a malignant neoplasm of the right breast, with secondary malignant neoplasms of the bone, left breast, left lung, and brain. Specifically, this patient seems to have had a progesterone- and estrogen-receptor-positive neoplasm. Both their breast and bone conditions were treated with somewhat standard therapy using exemestane and zoledronic acid respectively. 
